...
public class ProblemsService
{
    ...
    public Problem GetNext()
    {
        ...
        if (_currentProblemIndex == Problems.Count)
        {
            _currentProblemIndex = 0;
        }

        return Problems[_currentProblemIndex];
    }
